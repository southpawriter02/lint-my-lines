...
const { getAllCommentsCached, applyIgnoreRegex } = require("../utils/comment-utils");
    ...
    schema: [
      {
        ...
        properties: {
          ...
          ignoreRegex: {
            type: "string",
            description: "Custom regex pattern to strip from comment before checking references",
          },
        },
