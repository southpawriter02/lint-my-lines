        ...
        schema: [
            {
                ...
                properties: {
                    ...
                    ignoreUrls: {
                        type: "boolean",
                        description: "Ignore URLs when checking for obviousness (default: true)"
                    },
                    ignoreCodeBlocks: {
                        type: "boolean",
                    ...
                    ignoreRegex: {
                        type: "string",
                        description: "Custom regex pattern to strip before checking"
                    },
        ...
        return {
            Program() {
                ...
                for (const classified of classifiedComments) {
                    ...
                    let text = getFirstCommentLine(comment);

                    // v1.1.2: Apply ignore options before processing
                    if (ignoreUrlsOpt) {
                        text = stripUrls(text);
                    }
                    ...
                    if (ignoreRegexOpt) {
                        text = applyIgnoreRegex(text, ignoreRegexOpt);
                    }
