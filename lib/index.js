...
// v1.1.0: Config helper utilities
const configHelpers = require("./utils/config-helpers");
...
const requireAltTextComments = require("./rules/require-alt-text-comments");
const accessibilityTodoFormat = require("./rules/accessibility-todo-format");
const screenReaderContext = require("./rules/screen-reader-context");
...
const rules = {
  ...
  // Accessibility rules (v1.2.0)
  "require-alt-text-comments": requireAltTextComments,
  "accessibility-todo-format": accessibilityTodoFormat,
  "screen-reader-context": screenReaderContext,
};
...
module.exports = {
  ...
  // Config helpers (v1.1.0 - also available via "eslint-plugin-lint-my-lines/helpers")
  ...configHelpers,
};
