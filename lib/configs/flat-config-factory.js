...
const PRESET_DEFINITIONS = {
  ...
  /**
   * Accessibility preset - Accessibility-focused comment rules.
   *
   * Rules for documenting UI components for users with disabilities.
   * Helps ensure complex UI patterns are explained for screen readers
   * and assistive technologies.
   *
   * Best for:
   * - React/Vue/Svelte applications with complex UI
   * - Projects following WCAG guidelines
   * - Teams focused on inclusive development
   *
   * Rules: 3
   *
   * @since 1.2.0
  ...
  accessibility: {
    rules: {
      // Require comments for complex UI elements (icons, images, etc.)
      "lint-my-lines/require-alt-text-comments": "warn",

      // Enforce format for accessibility TODOs
      "lint-my-lines/accessibility-todo-format": "warn",

      // Require comments explaining screen reader behavior
      "lint-my-lines/screen-reader-context": "warn",
    },
  },

  // ---------------------------------------------------------------------------
  // File Type Presets (v1.1.1)
  // ---------------------------------------------------------------------------

  /**
   * Test files preset - Relaxed rules for test files.
   *
   * Test files often have different commenting needs:
   * - Mock data may look like commented code
   * - Test descriptions serve as documentation
   * - TODOs are often intentional test placeholders
   *
   * Best for:
   ...
   * - Storybook stories
   *
   * Rules: All rules OFF for test files
   *
   * @since 1.1.1
   */
  "test-files": {
    rules: {
      ...
      "lint-my-lines/enforce-fixme-format": "off",
      "lint-my-lines/enforce-note-format": "off",
      "lint-my-lines/no-commented-code": "off",
      "lint-my-lines/enforce-comment-length": "off",
      "lint-my-lines/enforce-capitalization": "off",
      "lint-my-lines/comment-spacing": "off",
      "lint-my-lines/ban-specific-words": "off",
      "lint-my-lines/no-obvious-comments": "off",
      "lint-my-lines/require-explanation-comments": "off",
      "lint-my-lines/require-jsdoc": "off",
      "lint-my-lines/valid-jsdoc": "off",
      "lint-my-lines/jsdoc-type-syntax": "off",
      "lint-my-lines/require-file-header": "off",
    },
  },

  /**
   * Generated files preset - Skip all rules.
   *
   * Generated files should not be linted as they are:
   * - Auto-generated (changes will be overwritten)
   * - Often minified or bundled
  ...
  generated: {
    rules: {
      ...
      "lint-my-lines/jsdoc-type-syntax": "off",
      "lint-my-lines/require-file-header": "off",
      "lint-my-lines/stale-comment-detection": "off",
      "lint-my-lines/todo-aging-warnings": "off",
      "lint-my-lines/comment-code-ratio": "off",
    },
  },
};
...
const LANGUAGE_PRESETS = {
   ...
   * Test files preset - Relaxed rules for test files.
   *
   * Applies relaxed comment rules to common test file patterns.
   *
   * @since 1.1.1
   */
  "test-files": {
    ...
    rules: PRESET_DEFINITIONS["test-files"].rules,
  },

  /**
   * Generated files preset - Skip linting for generated files.
   *
   * Applies to common generated file patterns.
   *
   * @since 1.1.1
   */
  generated: {
    ...
    rules: PRESET_DEFINITIONS.generated.rules,
  },

  /**
   * Minified files preset - Skip linting for minified files.
   *
   * Applies to common minified file patterns.
   *
   * @since 1.1.1
   */
  minified: {
    ...
    rules: PRESET_DEFINITIONS.generated.rules, // Reuse generated rules
  },
};
 ...
 * analysis (standalone)
 *
 * test-files (standalone) [v1.1.1]
 * generated (standalone) [v1.1.1]
 *   └── minified
 * ```
 *
...
const PRESET_INHERITANCE = {
  ...
  accessibility: null, // Standalone, no parent (v1.2.0)
  ...
  // File type presets (v1.1.1)
  "test-files": null, // Standalone, no parent
  generated: null, // Standalone, no parent
  minified: "generated", // Inherits from generated
};
